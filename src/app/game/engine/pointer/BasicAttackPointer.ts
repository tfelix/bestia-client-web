...
import {
  ComponentType, PositionComponent, VisualComponent, InteractionType,
  AttacksComponent, ConditionComponent, ConditionHelper, Entity, PlayerEntityHolder, EntityTypeComponent
...
export class BasicAttackPointer extends Pointer {
  ...
  private isAttackable(entity: Entity): boolean {
    ...
    const chachedInteraction = this.ctx.interactionCache.getDefaultInteraction(entity);
